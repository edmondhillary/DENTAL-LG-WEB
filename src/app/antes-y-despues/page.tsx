    ...
    <>
            ...
            <div style={{ background: "var(--surface-low)", padding: "2rem", borderRadius: "1rem", border: "1px solid rgba(195,198,214,.2)", maxWidth: 320 }}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: ".75rem" }}>
                <div style={{ width: 40, height: 40, borderRadius: 999, background: "#d5e3ff", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <span className="material-symbols-outlined" style={{ color: "var(--brand)" }}>verified</span>
                </div>
      ...
      <section style={{ padding: "5rem 2rem 8rem", maxWidth: 1280, margin: "0 auto", display: "grid", gap: "6rem" }}>
          ...
          <div key={item.title} style={{ display: "grid", gridTemplateColumns: index === 2 ? "repeat(2, minmax(0,1fr))" : "8fr 4fr", gap: "3rem", alignItems: "center" }}>
            {index !== 2 ? (
              <div style={{ position: "relative", display: "grid", gridTemplateColumns: "repeat(2, minmax(0,1fr))", gap: 8, background: "white", padding: 8, borderRadius: "1rem", boxShadow: "0 24px 80px rgba(25,28,30,.12)" }}>
                <div style={{ position: "relative", aspectRatio: "4 / 5", overflow: "hidden", borderRadius: ".75rem" }}>
                  ...
                  <div style={{ position: "absolute", top: 16, left: 16, background: "rgba(0,0,0,.4)", color: "white", padding: ".35rem .8rem", borderRadius: 999, fontSize: ".65rem", fontWeight: 800, textTransform: "uppercase", letterSpacing: ".14em" }}>Before</div>
                </div>
                <div style={{ position: "relative", aspectRatio: "4 / 5", overflow: "hidden", borderRadius: ".75rem" }}>
                  <Image src={imageUrl(item.image)} alt={`${item.title} después`} fill style={{ objectFit: "cover" }} />
                  <div style={{ position: "absolute", top: 16, right: 16, background: "rgba(27,68,119,.85)", color: "white", padding: ".35rem .8rem", borderRadius: 999, fontSize: ".65rem", fontWeight: 800, textTransform: "uppercase", letterSpacing: ".14em" }}>After</div>
                </div>
              </div>
            ) : (
            ...
            {index !== 2 ? (
              <div style={{ display: "grid", gap: "1.25rem" }}>
                <div>
                  <p style={{ color: "var(--secondary)", fontWeight: 800, fontSize: ".75rem", textTransform: "uppercase", letterSpacing: ".18em", marginBottom: ".75rem" }}>Case {String(912 + index).padStart(4, "0")} / {item.treatment}</p>
                ...
                <button style={{ display: "inline-flex", alignItems: "center", gap: ".5rem", border: 0, background: "transparent", color: "var(--brand)", fontWeight: 800, cursor: "pointer" }}>Ver caso detallado <span className="material-symbols-outlined">arrow_forward</span></button>
              </div>
            ) : (
              <div style={{ position: "relative", minHeight: 440, borderRadius: "2rem", overflow: "hidden" }}>
                <Image src={imageUrl("https://images.unsplash.com/photo-1588776814546-daab30f310ce?auto=format&fit=crop&w=1200&q=80")} alt="Whitening hero" fill style={{ objectFit: "cover" }} />
                ...
                <div style={{ position: "relative", zIndex: 1, height: "100%", padding: "3rem", display: "grid", gridTemplateColumns: "repeat(2, minmax(0,1fr))", alignItems: "center", gap: "2rem" }}>
                  <div style={{ color: "white" }}>
                    <span style={{ display: "inline-block", padding: ".35rem .8rem", borderRadius: 999, background: "rgba(255,255,255,.2)", backdropFilter: "blur(10px)", fontSize: ".65rem", fontWeight: 800, textTransform: "uppercase", letterSpacing: ".16em", marginBottom: "1rem" }}>Whitening</span>
                  ...
                  <div style={{ display: "flex", justifyContent: "center" }}>
                    <div style={{ width: 320, aspectRatio: "1 / 1", background: "rgba(255,255,255,.12)", backdropFilter: "blur(20px)", borderRadius: "1.5rem", border: "1px solid rgba(255,255,255,.2)", padding: "2rem", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", color: "white" }}>
                      <div style={{ width: 192, height: 192, borderRadius: 999, border: "8px solid rgba(255,255,255,.1)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "1.5rem" }}>
                        <span style={{ fontSize: "3rem", fontWeight: 900 }}>+8</span>
                      </div>
                      <h4 style={{ fontWeight: 800, fontSize: "1.25rem", marginBottom: ".5rem" }}>Progresión de tono</h4>
                      <p style={{ color: "rgba(255,255,255,.72)", fontSize: ".9rem", lineHeight: 1.7 }}>Medida sobre guía lineal para seguimiento más objetivo del tratamiento.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section style={{ padding: "4rem 0 0", textAlign: "center" }}>
          ...
          <p style={{ color: "var(--muted)", fontSize: "1.2rem", lineHeight: 1.8, maxWidth: 760, margin: "0 auto 2rem" }}>Las consultas son privadas, meticulosas y diseñadas alrededor de tu biología, tu estética y tus objetivos reales.</p>
